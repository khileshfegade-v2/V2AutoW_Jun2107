...
public class DeleteReportsAndLogs extends Constants {
	...
	@notes:			
							1. Deletes all Screenshots inside Screenshot Folder, Delete logs file inside Log Folder, Previous Execution Output folder, Previous Created testng.xml & Deletes the "Master.xslx" file
	...
	public static void deleteOldReports() {
		...
		@notes:				Deletes Screenshots inside Screenshot Folder, Delete log file inside Log Folder, Previous Execution Output folder, Previous Created testng.xml & Deletes the "Master.xslx" file
	...
	public static void delete(File file) throws IOException {
		...
		@method:			delete()
		@parameter:		File file
		@notes:				This method is called in deleteOldReports() method to delete all the folders passed in deletedeleteOldReports() method.
		@returns:			No return type
		@END
		 */
